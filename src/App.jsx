...
const ChatView = ({ user, onLogout }) => {
  const { messages, isTyping, isListening, startListening, handleUserMessage, initializeChat, handleOptionSelect, handleTableConfirm, handleRecipeAdd } = useChatLogic(user);
